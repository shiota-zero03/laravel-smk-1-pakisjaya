		...
		<tbody>
			...
			@foreach($member as $mem)
				<tr>
					...
					<td>
						<a href="{{ route('pembimbing.penilaian') }}/update-penilaian/{{ $mem->id_member }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
						<a href="{{ route('pembimbing.penilaian') }}/lihat-penilaian/{{ $mem->id_member }}" class="btn btn-primary"><i class="fas fa-eye"></i></a>
					</td>
				</tr>
			@endforeach
		</tbody>
