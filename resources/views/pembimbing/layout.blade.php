    ...
    <div class="collapse navbar-collapse px-4 w-auto mt-5" id="sidenav-collapse-main" style="min-height: 85vh;">
      <ul class="navbar-nav">
        <li class="nav-item mt-2">
          <a class="nav-link menu-side" href="{{ route('pembimbing.dashboard') }}">
        ...
        <div class="ms-4 down-menu" id="user">
          <li class="nav-item border-start my-0 pt-2">
            <a class="nav-link position-relative ms-0 ps-2 py-2 rounded-end menu-dropdown" href="{{ route('profil.pembimbing') }}">
        ...
        <li class="nav-item mt-2">
          <a href="javascript:;" class="d-flex align-items-center nav-link menu-side" name="product">
            ...
            <span class="nav-link-text ms-1">Data Bimbingan</span>
            <i class="fas fa-caret-down ms-auto"></i>
          </a>
        </li>
        <div class="ms-4 down-menu" id="product">
          <li class="nav-item border-start my-0 pt-2">
            <a class="nav-link position-relative ms-0 ps-2 py-2 rounded-end menu-dropdown " href="{{ route('pembimbing.absensipkl') }}">
              <span class="nav-link-text ms-1">Absensi PKL</span>
            </a>
          </li>
          <li class="nav-item border-start my-0 pt-2">
            <a class="nav-link position-relative ms-0 ps-2 py-2 rounded-end menu-dropdown" href="{{ route('pembimbing.penilaian') }}">
              <span class="nav-link-text ms-1">Penilaian PKL</span>
            </a>
          </li>
        </div>

        <li class="nav-item bg-danger rounded mt-2">
          <a class="nav-link" href="{{ route('logoutpembimbing') }}">
