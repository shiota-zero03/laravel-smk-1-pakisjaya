	...
	<div class="col-md-6 col-12">
		<div class="row">
			...
			<div class="col-md-8 col-12">
				...
				<a class="btn btn-primary" href="{{ route('siswa.editprofil') }}">Ubah Profil</a>
			</div>
		</div>
	</div>
	<div class="col-md-6 col-12">
		...
		@elseif($member->status_pkl == 'Menunggu ACC Guru')
		<strong><em>Menunggu ...</em></strong>
		@else
		<button class="btn btn-success" id="ajukan">Ajukan jadwal PKL</button>
		<form id="jadwal_pkl" action="{{ route('siswa.updateprofil') }}" method="post">
			@csrf
			<label>Lokasi PKL</label>
			<input type="text" name="lokasi_pkl" class="form-control" required="">
			<label>Mulai PKL</label>
			<input required="" type="date" name="mulai_pkl" class="form-control">
			<label>Selesai PKL</label>
			<input required="" type="date" name="selesai_pkl" class="form-control"><br>
			<button name="ajukansekarang" class="btn btn-dark">Ajukan Sekarang</button>
		</form>
		@endif
	</div>
	<div class="col-md-6 col-12">
