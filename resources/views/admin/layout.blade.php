    ...
    <div class="collapse navbar-collapse px-4 w-auto mt-5" id="sidenav-collapse-main" style="min-height: 85vh;">
      <ul class="navbar-nav">
        <li class="nav-item mt-2">
          <a class="nav-link menu-side" href="{{ route('admin.dashboard') }}">
        ...
        <div class="ms-4 down-menu" id="user">
          <li class="nav-item border-start my-0 pt-2">
            <a class="nav-link position-relative ms-0 ps-2 py-2 rounded-end menu-dropdown" href="{{ route('admin.user') }}">
              <span class="nav-link-text ms-1">Kelola User</span>
            </a>
          </li>
          <li class="nav-item border-start my-0 pt-2">
            <a class="nav-link position-relative ms-0 ps-2 py-2 rounded-end menu-dropdown" href="{{ route('admin.admin') }}">
        ...
        <div class="ms-4 down-menu" id="product">
          <li class="nav-item border-start my-0 pt-2">
            <a class="nav-link position-relative ms-0 ps-2 py-2 rounded-end menu-dropdown" href="{{ route('admin.pengajuanpkl') }}">
              <span class="nav-link-text ms-1">Pengajuan PKL</span>
            </a>
          </li>
          <li class="nav-item border-start my-0 pt-2">
            <a class="nav-link position-relative ms-0 ps-2 py-2 rounded-end menu-dropdown " href="{{ route('admin.absensipkl') }}">
              <span class="nav-link-text ms-1">Absensi PKL</span>
            </a>
          </li>
          <li class="nav-item border-start my-0 pt-2">
            <a class="nav-link position-relative ms-0 ps-2 py-2 rounded-end menu-dropdown " href="{{ route('admin.industripkl') }}">
              <span class="nav-link-text ms-1">Industri PKL</span>
            </a>
          </li>
        </div>        

        <li class="nav-item mt-2">
          <a href="{{ route('admin.penilaian') }}" class="d-flex align-items-center nav-link menu-side">
